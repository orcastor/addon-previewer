...
|视频|⌛|[vue-plyr](https://github.com/redxtech/vue-plyr)|[ffmpeg](https://github.com/FFmpeg/FFmpeg)转换成`HLS(m3u8)`|mp4、wmv、mkv等|fps和码率；可以尝试h.265；支持GPU加速（OpenCL/Vulkan/MPP）（可以用各种方言，比如Rockchip版支持Mali GPU）|
